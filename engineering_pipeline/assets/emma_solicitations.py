"""
EMMA Public Solicitations scraping asset
"""
...
from engineering_pipeline.models.engineering_models import EmmaPublicSolicitations
...
@asset(
    ...
    description="Scrapes EMMA Maryland public solicitations data"
)
def emma_public_solicitations(context: AssetExecutionContext) -> MaterializeResult:
    """Scrape EMMA public solicitations page and save raw HTML to database."""
    ...
    try:
        context.log.info("Starting EMMA public solicitations scrape...")
        ...
        # Create EmmaPublicSolicitations record for database storage
        scrape_time = datetime.now()
        emma_record = EmmaPublicSolicitations(
        ...
        context.log.info(f"Saved {records_saved} record(s) to engineering.bronze.emma_public_solicitations table")
        ...
        if isinstance(raw_body, str):
            ...
            if 'solicitation' in raw_body.lower():
                context.log.info("Page contains solicitation data")
        
        return MaterializeResult(
            metadata={
                "records_saved": records_saved,
                "database_table": "engineering.bronze.emma_public_solicitations",
